export const food = [
	{
		...
		coldSnacks: [
			{
				img: '../public/images/allMenu/coldSnacks/assorted-fish.jpg',
			...
			{
				img: '../public/images/allMenu/coldSnacks/eggplant-roulletes.webp',
			...
			{
				img: '../public/images/allMenu/coldSnacks/assorted-cheese.jpg',
				name: 'Ассорти сыров',
				weight: '210',
			...
			{
				img: '../public/images/allMenu/coldSnacks/meat-delicusi.jpg',
			...
			{
				img: '../public/images/allMenu/coldSnacks/salo-garlicGrenki.jpg',
			...
			{
				img: '../public/images/allMenu/coldSnacks/brouskett.jpg',
				name: 'Брускетта',
				weight: '70',
			...
			{
				img: '../public/images/allMenu/coldSnacks/burito.jpeg',
				name: 'Буррито',
				weight: '90',
			...
			{
				img: '../public/images/allMenu/coldSnacks/assorted-vegetables.jpeg',
	...
	},
	{
		...
		hotSnacks: [
			{
				img: '../public/images/allMenu/hotSnacks/ajarsky-hachapuri.jpg',
			...
			{
				img: '../public/images/allMenu/hotSnacks/chudu.jpg',
				name: 'Чуду',
				weight: '100',
			...
			{
				img: '../public/images/allMenu/hotSnacks/italian-pizza.jpg',
			...
			{
				img: '../public/images/allMenu/hotSnacks/home-pizza.jpg',
				name: 'Пицца домашняя',
				weight: '480',
			...
			{
				img: '../public/images/allMenu/hotSnacks/tomat-hachapuri.jpg',
			...
			{
				img: '../public/images/allMenu/hotSnacks/shpinat-hachapuri.jpeg',
			...
			{
				img: '../public/images/allMenu/hotSnacks/three-cheeses.jpg',
				name: 'Пицца три сыра',
				weight: '500',
			...
			{
				img: '../public/images/allMenu/hotSnacks/margarita-pizza.jpg',
	...
	},
	{
		...
		meatDishes: [
			{
				img: '../public/images/allMenu/meatDishes/keta-meat.jpg',
				name: 'Стейк из кеты',
				weight: '100',
			...
			{
				img: '../public/images/allMenu/meatDishes/spicy-krilyshki.jpg',
			...
			{
				img: '../public/images/allMenu/meatDishes/assorted-chicken.jpg',
			...
			{
				img: '../public/images/allMenu/meatDishes/assorted-chicken-and-pig.jpeg',
			...
			{
				img: '../public/images/allMenu/meatDishes/chicken-shashlyk.webp',
			...
			{
				img: '../public/images/allMenu/meatDishes/assorted-chickend-and-horse.jpg',
			...
			{
				img: '../public/images/allMenu/meatDishes/meat-pig-neck.jpg',
			...
			{
				img: '../public/images/allMenu/meatDishes/forel-meat.jpg',
	...
	},
	{
		...
		soupes: [
			{
				img: '../public/images/allMenu/soups/borsh-myasnoy.jpg',
				name: 'Борщ мясной ',
				weight: '300',
			...
			{
				img: '../public/images/allMenu/soups/solyanka.jpg',
				name: 'Солянка мясная',
				weight: '300',
			...
			{
				img: '../public/images/allMenu/soups/harcho.jpg',
				name: 'Харчо ',
				weight: '300',
			...
			{
				img: '../public/images/allMenu/soups/udon-c-kyricey-krevetikami.jpg',
			...
			{
				img: '../public/images/allMenu/soups/ramen-c-krevetikami.jpg',
			...
			{
				img: '../public/images/allMenu/soups/lagman.jpg',
				name: 'Лагман',
				weight: '300',
			...
			{
				img: '../public/images/allMenu/soups/meksikanskiy-chili.jpg',
	...
	},
	{
		...
		grillMenu: [
			{
				img: '../public/images/allMenu/grill/stejk-ribay.jpg',
				name: 'Стейк Рибай',
				weight: '100/50/30',
			...
			{
				img: '../public/images/allMenu/grill/stejk-new-york.jpg',
				name: 'Стейк Нью-Йорк',
				weight: '170/50/30',
			...
			{
				img: '../public/images/allMenu/grill/stejk-chak-roll.jpg',
				name: 'Стейк Чак Ролл',
				weight: '100/20/30',
			...
			{
				img: '../public/images/allMenu/grill/stejk-machete.jpg',
				name: 'Стейк Мачете',
				weight: '180/20/30',
			...
			{
				img: '../public/images/allMenu/grill/rebra.jpg',
			...
			{
				img: '../public/images/allMenu/grill/baranina-grill.jpg',
				name: 'Баранина гриль',
				weight: '150/30',
			...
			{
				img: '../public/images/allMenu/grill/govyadina-grill.jpg',
				name: 'Говядина гриль',
				weight: '160/30',
	...
	},
	{
		...
		fishDelicious: [
			{
				img: '../public/images/allMenu/fishDelicuos/morskoy-ej.jpg',
			...
			{
				img: '../public/images/allMenu/fishDelicuos/ugolnaya-ruba.jpeg',
				name: 'Угольная рыба',
				weight: '300',
			...
			{
				img: '../public/images/allMenu/fishDelicuos/assorty-morskoe-plato.jpg',
			...
			{
				img: '../public/images/allMenu/fishDelicuos/shushi-kotletu.jpg',
				name: 'Щучьи котлеты',
				weight: '140',
			...
			{
				img: '../public/images/allMenu/fishDelicuos/assorty-iz-ustriz.jpg',
			...
			{
				img: '../public/images/allMenu/fishDelicuos/file-paltysa.jpg',
				name: 'Филе палтуса',
				weight: '313',
	...
	},
	{
		...
		drinks: [
			{
				img: '../public/images/allMenu/drinks/seldereeyeviu-fresh.jpg',
			...
			{
				img: '../public/images/allMenu/drinks/apelsinoviu-fresh.jpg',
			...
			{
				img: '../public/images/allMenu/drinks/greypfrutoviu-fresh.jpg',
			...
			{
				img: '../public/images/allMenu/drinks/ananasoviu-fresh.jpg',
			...
			{
				img: '../public/images/allMenu/drinks/limonniu-fresh.jpeg',
				name: 'Лимонный фреш',
				weight: '250',
				about: 'сок натуральный свежевыжатый.',
				price: 190,
			...
			{
				img: '../public/images/allMenu/drinks/mineralnaya-voda-baykal.png',
			...
			{
				img: '../public/images/allMenu/drinks/mineralnaya-voda-narzan.jpg',
